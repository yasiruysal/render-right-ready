        ...
        <div className="w-6/12 max-md:w-full max-md:ml-0">
          <div className="flex w-full flex-col self-stretch m-auto py-1.5 max-md:max-w-full max-md:mt-10">
            ...
            <div className="flex items-stretch gap-4 mt-9 pl-4 py-[15px]">
              <button className="bg-[rgba(91,114,71,1)] shadow-[0px_2px_16px_rgba(91,114,71,0.1)] text-lg text-white font-normal px-7 py-5 rounded-full max-md:px-5 hover:bg-[rgba(81,104,61,1)] transition-colors">
                Pre-Order Nuvé
              </button>
