...
export const Navigation: React.FC = () => {
  return (
    <header className="bg-[rgba(243,233,222,1)] flex w-full items-center gap-5 text-lg text-black font-normal flex-wrap justify-between px-8 py-5 max-md:max-w-full max-md:px-5">
      ...
      <button className="bg-[rgba(91,114,71,1)] shadow-[0px_2px_16px_rgba(91,114,71,0.07)] self-stretch text-white pt-3 pb-[19px] px-5 rounded-full hover:bg-[rgba(81,104,61,1)] transition-colors">
        Pre-Order Nuvé
      </button>
    </header>
  );
